_: {
  wayland.windowManager.hyprland.settings = {
    ...
    bind = [
      ...
      "$mod CONTROL ALT SHIFT,K,exec,list-keybinds"
      "$mod SHIFT,Return,exec,rofi-launcher"
      "$mod SHIFT,W,exec,web-search"
      "$mod ALT,W,exec,wallsetter"
      "$mod SHIFT,N,exec,swaync-client -rs"
      "$mod,W,exec,brave --wayland-text-input-version=4 --gtk-version=4 --enable-features=TouchpadOverscrollHistoryNavigation,UseOzonePlatform --ozone-platform=wayland"
      # "$mod,Y,exec,kitty -e yazi"
      "$mod,E,exec,emopicker9000"
      "$mod,S,exec,screenshootin"
      "$mod,Z,exec,pypr zoom +1"
